...
def force_from_gravity(mass_one, mass_two, distance):
	...
	force_from_gravity = (GRAVITATION * mass_one * mass_two) / (distance * distance)
...
def escape_velocity(main_mass, distance_from_center):
	...
	return math.sqrt( 2 * GRAVITATION * main_mass / distance_from_center)
...
if __name__ == '__main__':
	...
	print("The force of attraction due to gravity between the earth and the sun is: " + str(attraction))
	...
	print("with capacity for " + str(EM_DRIVE_FORCE) + " Newtons of constant thrust:")
